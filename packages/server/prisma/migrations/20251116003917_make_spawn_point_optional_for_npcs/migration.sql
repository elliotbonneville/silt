...
INSERT INTO "new_characters" ("accountId", "attackPower", "createdAt", "currentRoomId", "defense", "diedAt", "hp", "id", "isAlive", "isDead", "lastActionAt", "maxHp", "name", "spawnPointId", "updatedAt") SELECT "accountId", "attackPower", "createdAt", "currentRoomId", "defense", "diedAt", "hp", "id", "isAlive", "isDead", "lastActionAt", "maxHp", "name", "spawnPointId", "updatedAt" FROM "characters";
