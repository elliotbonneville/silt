...
CREATE TABLE "new_ai_agents" (
    ...
    "eventQueueJson" TEXT NOT NULL DEFAULT '[]',
...
INSERT INTO "new_ai_agents" ("characterId", "conversationJson", "createdAt", "homeRoomId", "id", "lastActionAt", "maxRoomsFromHome", "relationshipsJson", "spatialMemory", "spatialMemoryUpdatedAt", "systemPrompt", "updatedAt") SELECT "characterId", "conversationJson", "createdAt", "homeRoomId", "id", "lastActionAt", "maxRoomsFromHome", "relationshipsJson", "spatialMemory", "spatialMemoryUpdatedAt", "systemPrompt", "updatedAt" FROM "ai_agents";
