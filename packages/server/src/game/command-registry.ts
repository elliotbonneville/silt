...
export const COMMAND_REGISTRY: readonly CommandDefinition[] = [
  ...
  },
  {
    name: 'listen',
    aliases: ['ls'],
    description: 'Listen carefully to overhear conversations',
    usage: 'listen <target>',
    category: 'observation',
    requiredArgs: ['target'],
    aiUsable: true,
  ...
  },
  {
    name: 'tell',
    aliases: ['t'],
    description: 'Say something specifically to one person (observable by others)',
    usage: 'tell <target> <message>',
    category: 'social',
    requiredArgs: ['target', 'message'],
    aiUsable: true,
  },
  {
    name: 'whisper',
    aliases: ['w'],
    description: 'Secretly whisper a message to a character (not overheard)',
  ...
  },
  {
    name: 'stop',
    aliases: [],
    description: 'Stop attacking and/or listening',
    usage: 'stop',
    category: 'combat',
    aiUsable: true,
  },
...
function getArgDescription(commandName: string, argName: string): string {
  const descriptions: Record<string, Record<string, string>> = {
    ...
    listen: { target: 'Name of the character to listen to' },
    tell: { target: 'Name of the character to talk to', message: 'What to say' },
    whisper: { target: 'Name of the character to whisper to', message: 'What to whisper' },
